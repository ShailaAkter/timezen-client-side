...
import DashboardMenu from '../ui/adminSideBar/DashboardMenu';
import { FaBars} from "react-icons/fa6"
import { useState } from 'react';
import DashboardIconMenu from '../ui/adminSideBar/DashboardIconMenu';
import AdminNavLink from '../ui/adminSideBar/AdminNavLink';
    ...
    <>
        ...
        <div className='lg:w-[300px] h-screen fixed left-0 top-0 bottom-0 bg-slate-950 flex flex-col justify-between' >
            <div className='lg:flex hidden flex-col px-10 text-slate-50'>
                ...
                <DashboardMenu handleSidebar={handleSidebar}/>
            </div>
